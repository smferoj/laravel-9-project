...
class ProductController extends Controller
{
    ...
    public function StoreProduct(Request $request){
        ...
        // Grasp products  category name and subcategory name form from database using product category and subcategory id.
       ...
       return redirect()->route('allproducts')->with('message', 'Product Created successfully!');
