      ...
      <div class="card-body">
        <form action="" method="POST">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="number" class="form-control" id="category_name" name="category_name" placeholder="200" />
            </div>
          </div>
          ...
          <div class="row mb-3">
            <label class="col-sm-2 col-form-label" for="basic-default-name">Product Count</label>
            <div class="col-sm-10">
              <input type="number" class="form-control" id="category_name" name="category_name" placeholder="20" />
            </div>
          </div>
