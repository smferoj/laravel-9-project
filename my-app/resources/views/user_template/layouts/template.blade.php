...
<html lang="en">
   <head>
      ...
      <!-- fevicon -->
      <link rel="icon" href="{{asset('home/assets/images/fevicon.png')}}" type="image/gif" />
      <!-- Scrollbar Custom CSS -->
      <link rel="stylesheet" href="{{asset('home/assets/css/jquery.mCustomScrollbar.min.css')}}">
      ...
      <link rel="stylesoeet" href="{{asset('home/assets/css/owl.theme.default.min.css')}}">
   ...
   <body>
               ...
               <div class="containt_main">
                  ...
                  <div class="header_box">
                     <div class="lang_box ">
                        ...
                        <img src="{{asset('home/assets/images/flag-uk.png')}}" alt="flag" class="mr-2 " title="United Kingdom"> English <i class="fa fa-angle-down ml-2" aria-hidden="true"></i>
                        </a>
                        <div class="dropdown-menu ">
                           <a href="#" class="dropdown-item">
                           <img src="{{asset('home/assets/images/flag-france.png')}}" class="mr-2" alt="flag">
                           French
                           </a>
                        </div>
                     </div>
      ...
      <div class="footer_section layout_padding">
         <div class="container">
            <div class="footer_logo"><a href="index.html"><img src="{{asset('home/assets/images/footer-logo.png')}}"></a></div>
            <div class="input_bt">
      ...
      <script src="{{asset('home/assets/js/jquery-3.0.0.min.js')}}"></script>
      <script src="{{asset('home/assets/js/plugin.js')}}"></script>
      <!-- sidebar -->
